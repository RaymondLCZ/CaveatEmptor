...
namespace UnitTest
{
    ...
    public class Test_Category
    {
        ...
        [TestCategory("Category")]
        [TestMethod]
        public void Can_Add_ChildCategory_OutSession()
        {
            ...
            Category cellPhone = new Category("Cell Phones");
            electronics.ChildCategories.Add(cellPhone);
            cellPhone.ParentCategory = electronics;
